DOCKER_BUILDKIT=1 docker build -t arturoalcaniz/users-service:latest -t arturoalcaniz/users-service:$(npm pkg get version | tr -d '"') -f Dockerfile .. --secret id=my_env,src=.env
if [ "$1" ]
  then
